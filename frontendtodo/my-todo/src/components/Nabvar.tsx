                    ...
                    <div className="hidden md:block">
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            {isAdmin && (
                                <button 
                                    type="button" 
                                    className="p-1 text-gray-400 hover:text-gray-500 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500 transition duration-200"
